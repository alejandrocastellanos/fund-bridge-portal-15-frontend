  ...
  return (
    <div className="hero-gradient pt-16 pb-12 px-4 sm:px-6 lg:px-0 animate-on-load">
      <div className="max-w-4xl mx-auto text-center">
        <div className="inline-block bg-ftblue/10 text-ftblue font-semibold px-4 py-1.5 rounded-full text-sm mb-6">
        ...
        <h1 className="font-display text-4xl md:text-5xl lg:text-6xl font-bold leading-tight mb-4">
          ...
          <br />
          <span className="text-ftblue">Tech-Enabled Platform</span>
        </h1>
